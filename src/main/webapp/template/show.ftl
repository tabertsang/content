    ...
    <div class="n-show f-cb" id="showContent">
        ...
        <div class="cnt">
            ...
            <#if user && user.usertype==0>
                <div class="num">购买数量：<#if !product.isBuy><span id="plusNum" class="lessNum"><a>-</a></span></#if><span class="totalNum" id="allNum">${product.buyNum}</span><#if !product.isBuy><span id="addNum" class="moreNum"><a>+</a></span></#if></div>
            </#if>
            <div class="oprt f-cb">
                <#if user && user.usertype==0>
                    <#if product.isBuy>
                ...
                <#if user && user.usertype==1>
                    <#if product.isSell>
                    <div class="num">销售数量：<span class="totalNum" id="allNum">${product.saleNum}</span></div>
                    </#if>
